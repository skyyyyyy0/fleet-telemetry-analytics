...
However, validation of the logistics pilot fleet revealed that several required signals are currently unavailable through GeoTab for the Hyundai pilot vehicles.
...
The objective of this project is to design, implement, and evaluate an FEI-Lite (Fuel Efficiency Index Lite) framework using GeoTab telemetry data from the logistics pilot fleet.
...
The following signals have been validated as available from the logistics pilot fleet:
