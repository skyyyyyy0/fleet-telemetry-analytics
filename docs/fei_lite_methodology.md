...
The objective of FEI-Lite is to create a practical fuel-efficiency scoring framework using currently available GeoTab telemetry data from the logistics pilot fleet.
...
Distance/Odometer data were not consistently available across all vehicles within the logistics pilot fleet.
...
Idle operation consumes fuel while generating little or no vehicle movement and was identified as one of the most important factors affecting fuel economy within the logistics pilot fleet.
...
During validation of the pilot fleet, increased idle activity was consistently associated with higher fuel consumption and lower apparent fuel economy.
...
Idle activity was identified as one of the most significant factors affecting fuel consumption within the logistics pilot fleet.
...
The current FEI-Lite framework was developed using the telemetry signals available within the logistics pilot fleet.
